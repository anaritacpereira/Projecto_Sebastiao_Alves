...
//main
$autor=getAutor();
$texto_grande=$autor["texto_grande"];
$texto_pequeno = substr($texto_grande, 0, 3000);
                    ...
                    <div class="col traco"></div>
                        <nav class="col-12 navbar navbar-expand-lg">
                            ...
                            <div class="collapse navbar-collapse justify-content-center" id="navbarNavDropdown">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link menu selected" aria-current="page" href="autor.php">autor</a>
                                </li>
        ...
        <main class="container-fluid px-0" id="main">
            <div class="row caixabranca2">
                <div class="col-7 textocaixa2 ms-5">
                    <div class="row">
                        <div class="col novidade">Autor</div>                        
                    </div>
                    <div class="row">
                        <div class="col t1">SOBRE MIM</div>                        
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="row d-flex align-items-center p-0 m-0">
                    <img class="p-0 img-autor2" src="<?= $autor["imagem"]; ?>">
                </div>
            

                <div class="row sobre d-md-none d-block" id="texto_pequeno">
                ...
                <div class="row sobre d-md-block d-sm-none d-none" id="texto_grande">
                    <div class="col-12 text-left p pt-4 pautor">
                        <?= $autor["texto_grande"]; ?> 
                        <br><br>
                    </div>
            ...
            <div class="row d-md-none d-sm-block">
                <div class="col-10 pt-5">
                        <button id="vermais" class="vermais" onclick="verMais()"></button>
                </div>
            </div>
