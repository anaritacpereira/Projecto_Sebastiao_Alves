        ...
        <div class="row caixas">
                <div class="col-12 bv_titulo p-4">
                    ...
                    <form action="autor.php" >
                        <label>Link da imagem do Autor da página Autor:</label>
                        <br>
                        <input type="text" name="imagem" value="<?= $autor["imagem"]; ?>" required="required" autofocus placeholder="Imagem">
                        <button> 
                        ...
                        <br><br>
                        <label>Texto sobre o Autor:</label>
                        <br>
                        <textarea name="texto_grande" id="texto" cols="30" rows="10"><?= $autor["texto_grande"]; ?></textarea>
                        <script>
                            ClassicEditor
