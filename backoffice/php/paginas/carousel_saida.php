        ...
        <div class="row caixas">
                <div class="col-12 bv_titulo p-4">
                    ...
                    <form action="carousel.php" >
                        ...
                        <br><br>
                        <label>Link da imagem do Banner para Desktop:</label>
                        <br>
                        ...
                        <br><br>
                        <label>Link da imagem do Banner para Mobile:</label>
                        <br>
                        <input type="text" name="imagem_mobile" value="<?= $carousel["imagem_mobile"]; ?>" required="required" placeholder="Link Imagem Desktop">
                        <button> 
                            <a href="../../../gestor/tinyfilemanager.php" target="_blank">
                                CARREGAR IMAGEM 
                            </a>
                        ...
                        <textarea name="texto" id="texto" cols="30" rows="10"><?= $carousel["texto"]; ?></textarea>
                        <script>
                            ClassicEditor
