                        ...
                        <nav class="col-12 navbar navbar-expand-lg">
                            ...
                            <div class="collapse navbar-collapse justify-content-center" id="navbarNavDropdown">
                                ...
                                <li class="nav-item dropdown">
                                    <a id="menu-dropdown" class="nav-link dropdown-toggle menu selected"  href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                        livros
                                    </a>
        ...
        <main class="container-fluid px-0" id="main">
            ...
            <div class="row caixabranca2">
                <div class="col-7 textocaixa2 ms-5">
                    ...
                    <div class="row">
                        <div class="col t1"><?= $livros["titulo"]; ?></div>                        
                    </div>
                </div>
            </div>

            
            <div class="row sobre livro d-flex">
                <div class="col-12 pt-5 ms-5">
                    <div class="row">
                            <div class="col-4 img-conteudo">
                                <img src="<?= $livros["imagem"]; ?>" alt="livro-conteudo">
                            </div>
                            <div class="col-7 p texto_livro">
                                <?= $livros["texto"]; ?>
                            </div>
                            <div class="col-11 text-end d-md-block d-none">
            ...
            <div class="row baixo">
                ...
                <nav class="col-12 navbar navbar-expand-lg  mn_menu">
                        ...
                        <div class="collapse navbar-collapse justify-content-center" id="navbarNavDropdown">
                            ...
                            <li class="nav-item">
                                <a class="nav-link menu selected" href="#menu-dropdown" onclick="abrir()">Livros</a>
                            </li>                           
                            <li class="nav-item">
                                <a class="nav-link menu" aria-current="page" href="imprensa.php">imprensa</a>
                            </li>
