            ...
            <div class="row d-flex justify-content-center text-center mt-5 d-md-block d-none">
                <div class="col-12 contactos">
                        <div class="row mt-5 d-flex justify-content-center text-center">
                            ...
                            <div class="col-3 ms-2 contato_titulo2">email</div>
                        </div>
            ...
            <div class="row d-block d-md-none mt-5 px-0">
                <div class="row d-flex justify-content-center text-center mt-5">
                            <div class="row mt-3 d-flex justify-content-center text-center">
                                ...
                                <div class="col-8   mt-4 contato_titulo2 pt-4">email</div>
            ...
            <div class="row baixo">
                ...
                <nav class="col-12 navbar navbar-expand-lg  mn_menu">
                        ...
                        <div class="collapse navbar-collapse justify-content-center" id="navbarNavDropdown">
                            ...
                            <!-- <li class="nav-item ">
                                <a class="nav-link menu" href="#menu-dropdown" onclick="abrir()">
                                    livros
                                </a> -->
                                <!-- <ul class="dropdown-menu">
                                    <li><a class="dropdown-item submenu" href="livros_1.php">Senhora do Amor e da Guerra</a></li>
                                    <li><a class="dropdown-item submenu mt-3" href="livros_2.php">O Velho que Pensava que Fugia</a></li>
                                    <li><a class="dropdown-item submenu mt-3" href="livros_3.php">O Caracol Estrábico</a></li>
                                    <li><a class="dropdown-item submenu mt-3" href="livros_4.php">O Colecionador de Amnésias</a></li>
                                </ul> 
                             </li>-->
