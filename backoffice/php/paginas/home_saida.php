        ...
        <div class="row caixas">
                <div class="col-12 bv_titulo p-4">
                    ...
                    <form action="home.php" >
                        <label>Link da imagem do Autor da página HOME:</label>
                        <br>
                        ...
                        <br><br>
                        <label>Texto do "Últimos Livros" da página HOME:</label>
                        <br>
                        <textarea name="ultimos_livros" id="texto" cols="30" rows="10"><?= $home["ultimos_livros"]; ?></textarea>
                        <script>
                            ClassicEditor
